      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              location.reload(true); // true from server and not browser cash which includes user menu
            }
...
var stripe = Stripe('pk_test_51ITjJDLMzNTXHjGD1Tmjm4yIUdkYCQ4LigJQAXAUkIGusxyjiNBUMi6oodmmV9w1qX6LMG9wQiQjBy4Gpt3B71uB00qJkI05u6');
